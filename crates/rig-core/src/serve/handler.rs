...
fn finish_unary(
    ...
    response.provider_response_headers = terminal.provider_response_headers.clone();
...
pub(crate) fn events_from_response(
    ...
    terminal.provider_response_headers = response.provider_response_headers.clone();
